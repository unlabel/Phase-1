...
describe("Функция getPadawanNames:", () => {
  ...
  it("returns array with padawan names from file `data/padawans.txt`", async () => {
    const expected = ["Revan", "Bastila Shan", "Jolee Bindo", "Juhani"];
    const received = await getPadawanNames();
